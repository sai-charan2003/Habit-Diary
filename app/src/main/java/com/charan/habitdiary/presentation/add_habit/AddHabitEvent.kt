...
sealed class AddHabitEvent {
    ...
    data class OnHabitTimeChange(val hour : Int, val minutes : Int) : AddHabitEvent()
    ...
    data class OnHabitReminderTimeChange(val hour : Int, val minutes : Int) : AddHabitEvent()
